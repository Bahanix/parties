...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { description: @party.description, location: @party.location, name: @party.name, slug: @party.slug, start_at: @party.start_at }
    end
  ...
  test "should update party" do
    put :update, id: @party, party: { description: @party.description, location: @party.location, name: @party.name, slug: @party.slug, start_at: @party.start_at }
    assert_redirected_to party_path(assigns(:party))
  end
